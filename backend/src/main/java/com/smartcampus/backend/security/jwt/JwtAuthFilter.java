    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            if (!JwtService.TOKEN_TYPE_ACCESS.equals(tokenType)
                    || (StringUtils.hasText(jti) && revokedTokenRepository.existsByJti(jti))) {
            ...
            if (StringUtils.hasText(email) && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                if (userDetails.isEnabled() && jwtService.isTokenValid(token, userDetails, JwtService.TOKEN_TYPE_ACCESS)) {
